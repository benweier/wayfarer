  ...
  return (
    ...
    >
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={cx(
            'data-[state=open]:animate-contentShow bg-background-primary border-border-primary ring-border-primary/20 fixed fixed top-[50%] left-[50%] z-50 max-h-[85vh] translate-x-[-50%] translate-y-[-50%] overflow-y-auto rounded-xl p-6 ring-3 focus:outline-none',
            {
              'w-auto': size === 'auto',
              'w-screen': size === 'full',
