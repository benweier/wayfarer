...
export const Preferences = () => {
  ...
  return (
    <Popover
      trigger={
        <button className="group flex w-full items-center gap-4 overflow-hidden rounded-md py-2 px-3 font-medium text-white transition-all duration-100 hover:bg-blue-50/10 hover:shadow-sm">
