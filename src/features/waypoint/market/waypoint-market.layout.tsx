  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col gap-4">
        <div className="text-xl text-left font-bold">{t('market.imports')}</div>
        <div className="grid grid-cols-1 gap-2">{imports}</div>
      </div>
      <div className="flex flex-col gap-4">
        <div className="text-xl text-left font-bold">{t('market.exports')}</div>
        <div className="grid grid-cols-1 gap-2">{exports}</div>
      </div>
      <div className="flex flex-col gap-4">
        <div className="text-xl text-left font-bold">{t('market.exchange')}</div>
