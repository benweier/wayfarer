    ...
    <div className="flex flex-col gap-1">
      <div className="flex flex-row gap-8">
        <div className="flex flex-col items-start">
          <div className="text-sm text-foreground-tertiary uppercase">{t('ship.transit.departed')}</div>
          <div className="flex items-center gap-2">
            <div className="font-medium">{t('formatter.datetime', { value: transit.departed })}</div>
          </div>
        </div>
        <div className="flex flex-col items-end">
          <div className="text-sm text-foreground-tertiary uppercase">
      ...
      <div className="flex flex-row items-center gap-2">
        ...
        <div className="text-sm flex w-12 justify-end text-right text-foreground-secondary">
